        ...
        <div className="flex flex-col gap-6 items-center justify-between mt-[64px] mb-10">
          ...
          <div className="flex flex-col mx-6 mt-12 mb-6">
              <div className="flex flex-row justify-between">
                <span className="font-medium leading-6 text-[18px] text-[#051320]">Email</span>
                ...
                <span className="font-medium leading-6 text-[18px] text-[#051320]">Theme</span>
                ...
                <div className="border border-[#EBEDEC] mt-6"></div>
                <div className="flex flex-row justify-between mt-7">
                <span className="font-medium leading-6 text-[18px] text-[#051320]">Data & storage</span>
                <span className="flex flex-row gap-4 text-[#616161] font-normal font-sans text-base leading-5">
                28% Used                 
               <img src={arrow} alt="" />
                </span>
                ...
                <div className="border border-[#EBEDEC] mt-6"></div>
                <div className="flex flex-row justify-between mt-7">
                <span className="font-medium leading-6 text-[18px] text-[#051320]">Change password</span>
                <span className="flex flex-row text-[#01CD98] font-normal font-sans text-base leading-5">
                  <img src={arrow} alt="" />
                </span>
                </div>
                ...
                <span className=" flex justify-between font-medium leading-6 text-[18px] text-[#051320]">Send feedback
                <img className="w-6 h-6" src={arrow} alt="" />
                </span>
                 <span className="text-[#616161] font-normal font-sans text-sm leading-[18px]">
                Chatbot AI can make mistakes. Consider checking important information and send us your feedback                </span>
