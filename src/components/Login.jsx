    ...
    <form onSubmit={handleLogin} className="">
      <div className="flex gap-3 relative items-center">
        ...
        <input
          ...
          className="outline-0 outline-transparent mb-6 rounded-2xl border border-[#EBEDEC] border-solid w-full h-[56px] placeholder: pl-[50px]"
          type="email"
          placeholder="Email"
          id="email"
        />
      ...
      <div className="flex gap-[12px] relative items-center">
        ...
        <input
          ...
          className=" outline-0 outline-transparent rounded-2xl border border-[#EBEDEC] border-solid w-full h-[56px] placeholder: pl-[50px]"
        ...
        >
          <Icon
            className="absolute right-6 top-4 text-[#01CD98] w-7 h-7"
            icon={icon}
          />
        </span>
      ...
      <button
        type="submit"
        className="cursor-pointer flex gap-2 justify-center text-center w-full h-[56px] px-6 py-[18px] rounded-[36px] bg-[#01CD98] text-white font-semibold text-base leading-5 ml-2"
      >
        Login
      </button>
    </form>
