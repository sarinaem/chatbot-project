    ...
    <div className="flex flex-row gap-4 mt-6 ml-4 flex-wrap items-center overflow-x-hidden">
      {data.map((item) => {
        ...
        return (
          <div
            key={item.id}
            className=" backdrop-blur-[30px] flex w-[43%] px-6 py-8 gap-3 rounded-[36px] border border-[#EBEDEC] flex-col mr-4"
          >
            ...
            <span className="text-[#616161] opacity-70 font-normal text-sm leading-[18px] font-sans">
              {item.time}
            </span>
          </div>
        );
