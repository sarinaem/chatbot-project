  ...
  return (
    <div className="flex flex-row gap-3 items-center justify-center mt-6">
      <input
        ...
        className=" w-[70%] rounded-[30px] border border-1 py-4 px-6 border-[#EBEDEC] ml-6 mb-6"
      />
      <button onClick={() => handleMsg(inputValue)}>
        <img
          src={sendIcon}
          alt="send"
          className=" bg-[#01CD98] p-4 rounded-full flex gap-2 mr-6 mb-6"
        />
      </button>
    </div>
  );
