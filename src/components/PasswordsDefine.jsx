  ...
  return (
    <form className="flex justify-center items-center flex-col gap-2">
        <div className="flex flex-row justify-center border-solid border-gray-100 text-nowrap mt-4">
            <label htmlFor="newPass" className="m-1 mt-3">New Password: </label>
            <input className=" rounded-2xl border border-[#EBEDEC] border-solidh-[56px]  placeholder: pl-[50px]" type="password" placeholder="Password" id="Password"/>
            </div>
            <Link to="/">
