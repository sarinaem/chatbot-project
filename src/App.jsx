    ...
    <div>
      <div className=" font-sans min-h-screen ml-8 mr-8 ">
        <div className="flex flex-col gap-[24px] py-[64px] px-[32px] font-sans max-w-[90vw] mx-auto">
          ...
          <h3 className="text-[40px] font-semibold leading-10">
            Login to your
            <br />
            account
          </h3>
        ...
        <div className="flex items-center mt-8 mb-8">
          ...
          <div className="flex-grow-0 mx-5 dark:text-white text-[#616161] font-normal leading-[18px] text-sm font-sans ">
            Or login with
          </div>
        ...
        <div className="flex flex-row justify-evenly">
          <button className="flex flex-row gap-2 bg-[#6464641F] py-4 px-6 rounded-[36px]">
            ...
            <p className="text-[#051320] font-semibold text-base font-sans leading-5">
              Google
            </p>
          </button>
          <button className="flex flex-row gap-2 bg-[#6464641F] py-4 px-6 rounded-[36px]">
